...
* added a favicon to the tab ([2bd625c](https://github.com/899ms/texture-ripper/commit/2bd625c1d44ca793bf44bca76fcc52da8914c34a))
* added prebuild script, removed unnecessary packages ([db0dacd](https://github.com/899ms/texture-ripper/commit/db0dacd89ea86fa06010991f2dcf4b8a2b1c688f))
* added restart to update indicator ([f0013d8](https://github.com/899ms/texture-ripper/commit/f0013d88d818a7f4dca551859e2c98e4e50f5eee))
* changed node version from 18 to 20 ([44f4a49](https://github.com/899ms/texture-ripper/commit/44f4a497438581d35c55f0a4a96d6b2454fcfec5))
* changed the branch from main to master in configurations ([f000568](https://github.com/899ms/texture-ripper/commit/f000568434ba0669f1538c10e6d76d37e113fc16))
* fixed the auto update UI ([fb49b4f](https://github.com/899ms/texture-ripper/commit/fb49b4f25bc79f8989f313b0ad72272a4a0d889e))
* fixed version numbers not updating ([eca43b6](https://github.com/899ms/texture-ripper/commit/eca43b63dbaadb244228be017b2aa36e9a9a3e3c))
* installed @semantic-release/exec ([82c00a2](https://github.com/899ms/texture-ripper/commit/82c00a246843dc61157dba309b843a0990472eb9))
* made the report issue and propose feature buttons open up links in browser inside electron ([c29aa50](https://github.com/899ms/texture-ripper/commit/c29aa50e5d02f6c7e334fc83cd4364329d9ea7e5))
* right panel version toolbar UI fixed ([70ae2b1](https://github.com/899ms/texture-ripper/commit/70ae2b15d0135cb2044f97bd28d4e0c2a7aed8f9))
* the version.json was not updating, added to workflow ([f364a78](https://github.com/899ms/texture-ripper/commit/f364a788568567eeb036f3dd05e0816b6ed3d1be))
* update UI aligned to right side of toolbar ([320ea05](https://github.com/899ms/texture-ripper/commit/320ea05da8b04bf5948d660a5fcac5bc9b1bc2e7))
* update workflow, removed the conditions ([0cc061c](https://github.com/899ms/texture-ripper/commit/0cc061ce6e1345dd3f2be41b07b1f525c3a375bf))
* updated the workflow to release github pages as well (final workflow update I swear) ([99ad97f](https://github.com/899ms/texture-ripper/commit/99ad97f553d6dda2903fc5218ff560fcb50db2ea))
* version number not updating again ([4ce81df](https://github.com/899ms/texture-ripper/commit/4ce81df937bb4bbfaf3099360462ad31a11e2543))
* workflow fix, version was always one version behind ([79699ac](https://github.com/899ms/texture-ripper/commit/79699ac65c0a59f968108da8a28e79a70b73335b))


### Features

* add auto-pack for left panel source images ([#24](https://github.com/899ms/texture-ripper/issues/24)) ([784fa0c](https://github.com/899ms/texture-ripper/commit/784fa0c073ab6e7abbb04738610f28a353627fc1))
* add auto-update with electron-updater ([a026031](https://github.com/899ms/texture-ripper/commit/a0260314f8bcae19e98db739c57631a430121714))
* add download button for desktop app in browser version ([936d206](https://github.com/899ms/texture-ripper/commit/936d2060e5403e21989b4811ead29d6350aac7a9))
* add padding/margin option to AutoPack ([bd0d5af](https://github.com/899ms/texture-ripper/commit/bd0d5af591e5b85b8e6d6049e8f211c55653e546))
* add undo/redo system (Ctrl+Z/Y) ([#22](https://github.com/899ms/texture-ripper/issues/22)) ([ee36a3f](https://github.com/899ms/texture-ripper/commit/ee36a3fad5acff002b6fd007f2fe13516905f920))
* added logic to detect shift to invert keep aspect ratio for use-konva-snapping.js ([70ba28e](https://github.com/899ms/texture-ripper/commit/70ba28e92553322a8526d9b261cff9c2ac9eb184))
* added request feature, report issue buttons and version number information ([614a049](https://github.com/899ms/texture-ripper/commit/614a049aa90066684949834456537be2f32f5dc5))
* auto update feature in .exe version ([1c9ca3c](https://github.com/899ms/texture-ripper/commit/1c9ca3c9d74179d8e6ed1650100260caab255640))
* by default the corner scaling will keep aspect ratio ([2ff9442](https://github.com/899ms/texture-ripper/commit/2ff94425a6c32ed0c4c7f2188c0d50a082922896))
* link rects to images toggle ([#25](https://github.com/899ms/texture-ripper/issues/25)) ([694415f](https://github.com/899ms/texture-ripper/commit/694415f77b67374ab0898b442dd4aeeb0bb9e3e1))
* Minor UI Improvements ([6d77408](https://github.com/899ms/texture-ripper/commit/6d7740896de02e9739e5855ce66a75cec1e6e1ca))
* pan with shift and lmb/trackpad ([c53901d](https://github.com/899ms/texture-ripper/commit/c53901db2a634a8751a8c9661de57e0cd84a7b74))
* update workflow and release config to trigger build ([69c53db](https://github.com/899ms/texture-ripper/commit/69c53db7ef83e1c8c5a612de41cca9b4c1dd2ba8))
* upgrade Konva version in CDN so that shift works to invert aspect when scaling transformers ([8f5467a](https://github.com/899ms/texture-ripper/commit/8f5467a8df8abfb5432b2569604d0c856d6c8ab0))
